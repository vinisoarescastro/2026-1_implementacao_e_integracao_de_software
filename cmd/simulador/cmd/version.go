...
//
//	go build -ldflags "-X github.com/kyriosdata/runner/cmd/simulador/cmd.version=v1.0.0"
//
...
var versionCmd = &cobra.Command{
	...
	Long:  `Exibe a versão atual do CLI simulador junto com o SO e a arquitetura.`,
